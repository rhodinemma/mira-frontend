...
//       // Simulate successful or failed deployment (80% success rate for demo)
//       const random = Math.random();
//       if (random > 0.2) {
//         simulateDeployment(values);
//       } else {
//         simulateFailedDeployment(values);
//       }
//     } catch (err) {
//       setError(
...
//     switch (type) {
//       case "Public Git Repository":
//         return <IconGitMerge size={16} />;
//       case "Private Git Repository":
...
//             Deploy your application using our new and improved deployment
//             workflows
//           </Text>
...
//               <Group>
//                 <IconCodeCircle2 size="1.2rem" />
//                 <Text fw={500}>Application Details</Text>
//               </Group>
...
//                     placeholder="Select source code type"
...
//                   {form.values.sourceCodeType &&
//                     form.values.sourceCodeType !== "Zip File" && (
//                       <TextInput
//                         required
//                         label="Repository URL"
//                         placeholder="Enter repository URL"
//                         leftSection={getSourceTypeIcon(
//                           form.values.sourceCodeType
//                         )}
...
//                       {...form.getInputProps("zipFile")}
//                       onChange={(file) => {
//                         form.setFieldValue("zipFile", file);
//                       }}
//                     />
//                   )}
...
//                   <Text fw={500}>Deployment Logs</Text>
//                 </Group>
//                 <Group>
...
//                     color={deploymentProgress === 100 ? "teal" : "blue"}
//                     size="sm"
//                     radius="xl"
//                     animate
//                   />
...
//               <ScrollArea h={200} type="auto" offsetScrollbars ref={logsRef}>
//                 <Stack spacing={4}>
...
//           {/* Deployment Summary - Only shown on success */}
//           {submissionState === "success" && deploymentStatus && (
...
//                   </ThemeIcon>
//                   <div>
//                     <Text fw={500}>{form.values.applicationName}</Text>
...
//                     </Text>
//                     <Text fw={500} size="sm">
//                       {deploymentStatus.replicas}/1 ready
//                     </Text>
//                   </Card>
//                 </Grid.Col>
//               </Grid>
...
//     },
//     { value: "Custom URL", label: "Custom URL", icon: <IconLink size={16} /> },
//     { value: "Zip File", label: "Zip File", icon: <IconUpload size={16} /> },
//   ];
...
//                 <Accordion.Item value="deployment-details">
//                   <Accordion.Control icon={<IconServer size="1rem" />}>
//                     Deployment Details
//                   </Accordion.Control>
//                   <Accordion.Panel>
//                     <Grid>
...
//                         >
//                           {form.values.sourceCodeLocation ||
//                             (form.values.zipFile && form.values.zipFile.name) ||
//                             "N/A"}
//                         </Text>
//                       </Grid.Col>
//                       <Grid.Col span={6}>
...
//                         </Text>
//                         <Text size="sm" c="dimmed">
//                           CPU: {deploymentStatus.resources.cpu}, Memory:{" "}
//                           {deploymentStatus.resources.memory}
//                         </Text>
//                       </Grid.Col>
//                     </Grid>
//                   </Accordion.Panel>
          ...
          {/* {submissionState === "success" && deploymentStatus && (
            <Card withBorder p="md" radius="md">
              ...
              <Accordion variant="separated" radius="md">
                    ...
                    <Grid>
                      ...
                      <Grid.Col span={6}>
                        ...
                        {deploymentStatus.repository ? (
                          <Group spacing="xs">
                            {getProviderIcon(
                              deploymentStatus.repository.provider
                            )}
                            <Anchor
                              size="sm"
                              href="#"
                ...
                <Accordion.Item value="additional-actions">
                  <Accordion.Control icon={<IconRocket size="1rem" />}>
                    Additional Actions
                  </Accordion.Control>
                  <Accordion.Panel>
                    <SimpleGrid cols={2}>
